$(function(){
    ...
    var clock = $('#clock'),
        ...
        beginlunch,
        endlunch,
        ms_defaultTimer, // ms for main timer
        minutes_defaultTimer, // min from ms for main timmer
        defaultTimer, //main timer Tock instance
        ms_breakTimer, // ms for break timer
        minutes_breakTimer, // min from ms for break timer
        breakTimer, // break timer Tock instance
        currentTime,
        time;
    ...
    beginwork = moment(moment().hour(9).minute(0)).format('H:mm');
    endwork = moment(moment().hour(17).minute(0)).format('H:mm');
    beginlunch = moment(moment().hour(12).minute(0)).format('H:mm');
    endlunch = moment(moment().hour(13).minute(0)).format('H:mm');
    ...
    ms_defaultTimer = 20000; // needs to be in ms
    minutes_defaultTimer = Math.floor((ms_defaultTimer / 1000) / 60);
    defaultTimer = new Tock({
        countdown: true,
        interval: 0,
        complete: function(){
    ...
    // Actual function that begins a one hour timer
    ...
    ms_breakTimer = 10000; // needs to be in ms
    minutes_breakTimer = Math.floor((ms_breakTimer / 1000) / 60);
    breakTimer = new Tock({
        countdown: true,
        interval: 0,
        complete: function(){
